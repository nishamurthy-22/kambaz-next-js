...
export default function Lab1() {
  return (
    <div id="wd-lab1">
        ...
        My favorite recipe: Chilli Cheese Maggi
        <ol id="wd-your-favorite-recipe">
            <li>Boil the water.</li>
            <li>Add salt, chilli powder, Garam Masala, Maggi Masala.</li>
            <li>Stir to combine.</li>
            <li>Let the water boil.</li>
            <li>Add the noodle cakes to the boiling water.</li>
            <li>Cook until the water evaporates 80%</li>
            <li>Add cheese, chiili flakes and oregano</li>
            <li>Switch on your favourite show and enjoy your Chilli Cheese Maggi!</li>
        </ol>
